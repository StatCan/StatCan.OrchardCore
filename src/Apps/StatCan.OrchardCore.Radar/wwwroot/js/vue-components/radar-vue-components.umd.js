...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"b1143254-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/Apps/StatCan.OrchardCore.Radar/Assets/js/vue-components/components/GlobalSearch.vue?vue&type=template&id=2600493a&
var GlobalSearchvue_type_template_id_2600493a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"global-search-container"},[_c('v-icon',{staticClass:"mr-5",attrs:{"color":"white"}},[_vm._v(" mdi-magnify ")]),_c('input',{directives:[{name:"model",rawName:"v-model.trim",value:(_vm.searchText),expression:"searchText",modifiers:{"trim":true}}],staticClass:"global-search",attrs:{"type":"text","placeholder":_vm.placeholder},domProps:{"value":(_vm.searchText)},on:{"input":[function($event){if($event.target.composing){ return; }_vm.searchText=$event.target.value.trim()},function($event){_vm.isTyping = true}],"blur":function($event){return _vm.$forceUpdate()}}}),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.showDropdown),expression:"showDropdown"}],ref:"dropdownResult",staticClass:"dropdown-list"},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.projects.length > 0),expression:"projects.length > 0"}]},[_c('div',{staticClass:"result-caption"},[_c('v-icon',{staticClass:"mr-3",attrs:{"color":"#009688"}},[_vm._v("mdi-flask-outline")]),_c('div',[_vm._v(_vm._s(_vm.projectTitle))])],1),_vm._l((_vm.projects),function(item){return _c('div',{key:item.name,staticClass:"dropdown-item"},[_c('a',{staticClass:"black--text",attrs:{"href":item.AutoroutePart.Path}},[_vm._v(_vm._s(item.DisplayText))])])})],2),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.communities.length > 0),expression:"communities.length > 0"}]},[_c('div',{staticClass:"result-caption"},[_c('v-icon',{staticClass:"mr-3",attrs:{"color":"#009688"}},[_vm._v("mdi-account-multiple")]),_c('div',[_vm._v(_vm._s(_vm.communityTitle))])],1),_vm._l((_vm.communities),function(item){return _c('div',{key:item.name,staticClass:"dropdown-item"},[_c('a',{staticClass:"black--text",attrs:{"href":item.AutoroutePart.Path}},[_vm._v(_vm._s(item.DisplayText))])])})],2),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.events.length > 0),expression:"events.length > 0"}]},[_c('div',{staticClass:"result-caption"},[_c('v-icon',{staticClass:"mr-3",attrs:{"color":"#009688"}},[_vm._v("mdi-calendar")]),_c('div',[_vm._v(_vm._s(_vm.eventTitle))])],1),_vm._l((_vm.events),function(item){return _c('div',{key:item.name,staticClass:"dropdown-item"},[_c('a',{staticClass:"black--text",attrs:{"href":item.AutoroutePart.Path}},[_vm._v(_vm._s(item.DisplayText))])])})],2),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.proposals.length > 0),expression:"proposals.length > 0"}]},[_c('div',{staticClass:"result-caption"},[_c('v-icon',{staticClass:"mr-3",attrs:{"color":"#009688"}},[_vm._v("mdi-alert-circle-outline")]),_c('div',[_vm._v(_vm._s(_vm.communityTitle))])],1),_vm._l((_vm.proposals),function(item){return _c('div',{key:item.name,staticClass:"dropdown-item"},[_c('a',{staticClass:"black--text",attrs:{"href":item.AutoroutePart.Path}},[_vm._v(_vm._s(item.DisplayText))])])})],2)])],1)}
var GlobalSearchvue_type_template_id_2600493a_staticRenderFns = []


// CONCATENATED MODULE: ./src/Apps/StatCan.OrchardCore.Radar/Assets/js/vue-components/components/GlobalSearch.vue?vue&type=template&id=2600493a&

// EXTERNAL MODULE: ./src/Apps/StatCan.OrchardCore.Radar/node_modules/lodash/lodash.js
var lodash = __webpack_require__("ba80");
...
/* harmony default export */ var GlobalSearchvue_type_script_lang_js_ = ({
  ...
  watch: {
    searchText: lodash_default.a.debounce(function () {
      this.isTyping = false;
    }, 1000),
...
var GlobalSearch_component = normalizeComponent(
  ...
  GlobalSearchvue_type_template_id_2600493a_render,
  GlobalSearchvue_type_template_id_2600493a_staticRenderFns,
  false,
  null,
  null,
  null
