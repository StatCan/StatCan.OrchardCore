...
export declare class DragDropTD extends Vue {
    question: any;
}
...
export declare class DefaultTitle extends Vue {
    ...
    get showIcon(): any;
    changeExpanded(): void;
    getIconCss(isCollapsed: boolean): any;
    mounted(): void;
}


export declare class ActionBarViewModel extends Vue {
    items: Array<IActionBarItem>;
    handleClick: boolean;
    constructor();
    get wrappedItems(): import("survey-core").AdaptiveActionBarItemWrapper[];
