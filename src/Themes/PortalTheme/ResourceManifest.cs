    ...
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                ...
                .SetVersion("1.0.0");
            manifest
                .DefineStyle("PortalTheme-vendor-font-awesome")
                ...
                .SetVersion("5.13.0");
            manifest
                .DefineScript("PortalTheme-vendor-font-awesome")
            ...
            manifest
                .DefineScript("PortalTheme-vendor-jQuery")
                ...
                .SetVersion("3.4.1");
            manifest
                .DefineScript("PortalTheme-vendor-popper")
            ...
            manifest
                .DefineScript("PortalTheme-vendor-bootstrap")
                .SetDependencies("PortalTheme-vendor-jQuery", "PortalTheme-vendor-popper")
