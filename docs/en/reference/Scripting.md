...
| Function | Description 
| -------- | ----------- |
| `saveMedia(folder: String, generateFileNames: Boolean): SaveMediaResult[]` | Saves all files present on the HttpRequest to a specific folder. Filenames can be generated by passing true to the second argument |
